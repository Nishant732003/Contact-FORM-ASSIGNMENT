...
const Home: NextPage = () => {
 ...
 <div className="bg-gray-600 h-screen flex justify-center items-center">
        <div className="grid md:grid-cols-2 overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-white my-6 font-[sans-serif]">
      <div className="sm:p-10 max-sm:px-4 max-sm:py-8 bg-gray-900">
        ...
        <form action="#" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="mt-8 flex items-center justify-center text-sm w-full rounded px-4 py-2.5 font-semibold bg-yellow-600 text-white hover:bg-yellow-700"
          >
            Send Message
          </button>
        </form>
